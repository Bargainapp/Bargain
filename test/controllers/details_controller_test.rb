...
class DetailsControllerTest < ActionController::TestCase
  ...
  test "should create detail" do
    assert_difference('Detail.count') do
      post :create, detail: { description: @detail.description, outlet: @detail.outlet, price: @detail.price, title: @detail.title }
    end
  ...
  test "should update detail" do
    patch :update, id: @detail, detail: { description: @detail.description, outlet: @detail.outlet, price: @detail.price, title: @detail.title }
    assert_redirected_to detail_path(assigns(:detail))
  end
